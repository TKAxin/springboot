package com.xpx.springboot.config;
...
public class SwaggerConfig {
    ...
    public Docket restApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.xpx.springboot.controller"))
     ...
     * 访问地址：http://localhost:9090/swagger-ui/index.html#/test-controller/selectByIdUsingGET
     *
     * @return
     */
